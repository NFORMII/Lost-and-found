...
import 'package:letsfind/screens/feeds/notifications.dart';
import 'package:letsfind/screens/profile/profile_screen.dart';
import '../services/firestore_service.dart';

class CommunityFeed extends StatefulWidget {
  const CommunityFeed({super.key, required String filter});
        ...
        Container(
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: service.streamPosts(selectedCategory),
              builder: (context, snapshot) {
                ...
                if (filteredPosts.isEmpty) {
                  return _buildEmptyState(message: "No matching results");
                }
...
//                       decoration: BoxDecoration(
//                         color: data['status'] == 'found' ? Colors.green[50] : Colors.green[50],
//                         borderRadius: BorderRadius.circular(8),
//                       ),
//                       child: Text(
//                         (data['status'] ?? '').toUpperCase(),
//                         style: TextStyle(
//                           color: data['status'] == 'found'? Colors.green: Colors.green,
//                           fontSize: 10,
//                           fontWeight: FontWeight.bold,
//                         ),
//                       ),
